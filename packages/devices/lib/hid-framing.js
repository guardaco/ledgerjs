  ...
  return {
    ...
    reduceResponse: function reduceResponse(acc, chunk) {
      ...
      if (chunk.readUInt16BE(0) !== channel) {
        throw new _lib.TransportError("Invalid channel", "InvalidChannel");
      }
      if (chunk.readUInt8(2) !== Tag) {
        throw new _lib.TransportError("Invalid tag", "InvalidTag");
      }
      if (chunk.readUInt16BE(3) !== sequence) {
        throw new _lib.TransportError("Invalid sequence", "InvalidSequence");
      }
